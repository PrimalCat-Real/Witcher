...
public class CatSchoolArmor extends WitcherArmor {
    public CatSchoolArmor(RegistryEntry<ArmorMaterial> material, ArmorItem.Type slot, Item.Settings settings) {
    ...
    private static Item.Settings addGlyphSlots(Item.Settings settings, ArmorItem.Type slot, int glyphSlots) {
        if (slot == ArmorItem.Type.CHESTPLATE) {
            ...
            // If the material-based logic is still desired, it needs to be re-integrated.
