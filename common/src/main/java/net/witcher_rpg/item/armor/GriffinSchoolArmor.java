...
public class GriffinSchoolArmor extends WitcherArmor {
    public GriffinSchoolArmor(RegistryEntry<ArmorMaterial> material, ArmorItem.Type slot, Item.Settings settings) {
